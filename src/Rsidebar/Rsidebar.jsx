    ...
    <>
      <div className=" h-[600px] w-[280px] mt-24 rounded-t-lg fixed ml-[1125px]">
        <div className="w-[280px]  shadow-md rounded-xl bg-[#152331] overflow-hidden">
          ...
          <div className="w-full h-[294px] rounded-xl mt-[11px] overflow-auto no-scrollbar">
            <div className=" mt-[15px] ml-3  rounded-xl mb-5   ">
              <Chatapprightsidebar query={query}></Chatapprightsidebar>
            </div>
          </div>
        </div>
